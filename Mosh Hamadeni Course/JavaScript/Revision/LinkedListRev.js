...
class LinkedList {
  ...
  // I need fast and slow, the fast will moved double the speed and keep checking, if it reaches the end it means
  // there is no cycle, if at some point it passes the first pointer it means there is a cycle
  hasLoop() {
    let fast = this.first;
    let slow = this.first;
